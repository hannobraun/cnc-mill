...
fn cnc() -> fj::Shape {
    ...
    let y_axis_rail_worst_case_torque = worst_case_force
        .value()
        .to_torque(y_axis_rail_max_distance_to_force);
    println!(
        "Worst-case torque at y-axis rail: {}",
        y_axis_rail_worst_case_torque
    );
